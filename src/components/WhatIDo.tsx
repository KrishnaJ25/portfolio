        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building robust, high-performance backend systems and RESTful APIs with a focus on
                security, scalability, and clean architecture.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Servlets</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing cloud-native architectures and CI/CD pipelines that ensure high availability,
                automated deployments, and zero-downtime releases.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
